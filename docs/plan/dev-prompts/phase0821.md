...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-18-VLM資料夾推薦.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-19-上傳存檔與讀圖端點.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-20-上傳未分類流程與規格改版.md`
