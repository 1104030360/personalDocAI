...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-93-GitHub_OIDC與部署角色.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-94-CD工作流程.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-95-增量六錯誤收尾與驗收包.md`
