...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-15-資料庫一次改版與預設資料夾.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-16-資料夾資料層.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-17-檔案儲存服務.md`
