...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-00-總覽.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-01-環境準備.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-02-專案骨架.md`
2.目前專案後端程式碼如下：
3.目前的專案前端程式碼如下：
