...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-73-pre-commit與CI.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-74-隱私閘門規則版.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-75-隱私閘門本機端.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-76-入庫任務拆成看圖與落庫.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-77-雲端路契約與第五道安全網.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-78-閘門接線與fallback契約.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-79-雲端路本機端單圖.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-80-雲端路逾時與冪等.md`
