...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-87-cloud_worker模組.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-88-EC2探測running.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-89-worker映像arm64.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-90-EC2的網路IAM與ECR.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-91-EC2的網路IAM與ECR.md`
