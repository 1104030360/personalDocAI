...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-65-Celery與Redis實作.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-66-Compose加redis與worker.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-67-全站進度面板.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-68-上傳頁多檔選檔.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-69-鏡頭連拍與桌面拿掉開鏈.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-70-待決定走完整三關.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-71-增量五錯誤收尾與全量回歸.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-72-規格檔改版與增量五驗收包.md`
