...
# 背景知識
1.目前專案的計劃要做的事情如下： 
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-83-aws_mailbox模組.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-84-建S3寄物櫃.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-85-建SQS兩條佇列.md`
`/Users/linjunting/personalDocAI/docs/plan/unfinish/phase-86-真AWS雲端路接線.md`
